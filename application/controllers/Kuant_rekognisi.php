...
class Kuant_rekognisi extends CI_Controller
{
    ...
    public function insert()
    {
        ...
        Redirect(base_url() . 'Kuant_rekognisi/indikator/' . $this->input->post('id_survei', true) . '/' . $this->input->post('id_indikator', true), false);
    }
    public function get()
    {
    ...
    public function hapus()
    {
        ...
        Redirect(base_url() . 'Kuant_rekognisi/indikator/' . $this->input->get('id_survei', true) . '/' . $this->input->get('id_indikator', true), false);
    }
}
