    ...
    <head>
        ...
        <link href="<?php echo base_url()."assets/"; ?>theme/assets/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url()."assets/"; ?>theme/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" /><!-- END PAGE LEVEL PLUGINS -->
        ...
        <link href="<?php echo base_url()."assets/"; ?>theme/assets/global/css/custom.css" rel="stylesheet" type="text/css" />
