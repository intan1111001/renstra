                                     ...
                                     <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <select id="tahun" class="form-control" placeholder="Masukkan Tahun Survei" id="tahun" name="tahun">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <select id='tipe' class="form-control" placeholder="Masukkan Jenis PPM" id="tipe" name="tipe">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <input type='text' class="form-control" placeholder="Masukkan Tema" name="tema" id="tema">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa fa-book"></i>
                                                    <input type='text' class="form-control" placeholder="Masukkan Mahasiswa" name="mahasiswa" id="mahasiswa">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-responsive table-hover" id="sample_1">
                        ...
                        "> Koreksi </button> </i>
                                   <a class="btn red" href="<?= base_url() ?>Kuant_ppm_mahasiswa/hapus?id=<?= $model->id ?> &id_survei=<?=$id_survei ?>&id_indikator=<?=$id_indikator ?> "> <i class="fa fa-trash"></i> Hapus</a> </i> </td>
