            ...
            <div class="page-content">
                <!-- BEGIN CONTENT BODY -->
                            ...
                            <div class="portlet-body form">
								...
								<div class="form-group">
											...
											<div class="col-md-11">
												<div class="input-icon right">
													...
													<select id="tahun" class="form-control" placeholder="Masukkan Tahun Kerjasama" name="tahun">
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-11">
                                            <div class="input-icon right">
                                                ...
                                                <input type="text" class="form-control" placeholder="Masukkan lembaga yang terlibat dalam kerjasama" id='lembaga' name='lembaga'> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <select class="form-control" name='tingkat' id=>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-11">
                                            <div class="input-icon right">
                                                <input type="text" class="form-control" placeholder="Masukkan Judul Kegiatan Kerjasama" id='judul' name='judul'> </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-11">
                                            <div class="input-icon right">
                                                <input type="text" class="form-control" placeholder="Masukkan Manfaat Kerjasama" id ="manfaat" name='manfaat'> </div>
                                        </div>
                                    </div>
                    ...
                    <table class="table table-striped table-bordered table-responsive table-hover" id="sample_1">
                        ...
                        "> Koreksi </button> </i>
                                        <a class="btn red" href="<?= base_url() ?>Kuant_kerjasama/hapus?id=<?= $model->id ?> &id_survei=<?=$id_survei ?>&id_indikator=<?=$id_indikator ?> "> <i class="fa fa-trash"></i> Hapus</a> </i> </td>
